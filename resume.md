...
### 2019.06 ~ 현재: [차봇 모빌리티](https://www.chabot.kr/) 재직 중

- 차봇프라임 개발 및 유지보수 [PlayStore](https://play.google.com/store/apps/details?id=com.chabotprime&hl=ko&gl=US), [AppStore](https://apps.apple.com/kr/app/%EC%B0%A8%EB%B4%87%ED%94%84%EB%9D%BC%EC%9E%84/id1492427449) - React Native, GraphQL(Prisma v1), Next.js, Nest.js

### 2017.03 ~ 2017.07: Finfra
- 이미지 Annotation 웹 어드민 개발 - 개발스택: [Elm](https://elm-lang.org/)
...
- 다룬 주요 기술스택: React Native(0.61), React Navigation(v5), CodePush, GraphQL(Prisma v1), Nest.js, Next.js, Firebase, [node-http-proxy](https://www.npmjs.com/package/http-proxy)
...
- 다룬 주요 기술스택: React Native(0.60), Nest.js, [ZongJi](https://www.npmjs.com/package/zongji)
