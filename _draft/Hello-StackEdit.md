...
그러나 파일명을 ascii로 인코딩하는 방식이라 기존대로는 한글 URL을 만들 수가 없었다. 장점으로 내세웠던 Jinja 템플릿 지원 부분에서 truncate 메서드가 작동하지 않았다. 이렇게 모든 메서드를 지원하지 않아 잦은 오류를 겪게 되니, 본인의 신뢰가 깨졌다. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjg5NjM3OTUsLTc3NzU3NzA2MSw2MDEyOT
A4NTFdfQ==
-->